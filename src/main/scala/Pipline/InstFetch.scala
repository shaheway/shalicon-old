...
import connect.{InstIO, CsrReadIO, CsrWriteIO, IfidIO, ExIfIO}
class InstFetch extends Module {
  ...
  io.csr_read.reg_raddr := ecall_addr // 将0x305传给csr
  val ecall_data = io.csr_read.reg_rdata // 接收csr的0x305处的内容
